...
Class Email extends MY_Controller
{
    ...
    private function send()
    {
        ...
        $email_recruit = 'tuyendung.Khoan giếng bình yênvietnam@gmail.com';
        ...
        $this->email->to($list);
        $this->email->subject('Khoan giếng bình yên tuyển dụng ' . $department);
        $this->email->message('Chào bạn, chúng tôi gửi thư này cho bạn từ phòng Nhân sự của công ty cổ phần truyền thông Khoan giếng bình yên Việt Nam.<br>
