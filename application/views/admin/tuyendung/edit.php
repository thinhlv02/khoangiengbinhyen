                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <select name="slDepartment" id="slDepartment" class="form-control col-md-7 col-xs-12">
                            <option value="10" <?php echo ($recruitment->department == 10) ? 'selected' : ''?> >Thợ Kỹ thuật</option>
                            <option value="11" <?php echo ($recruitment->department == 11) ? 'selected' : ''?> >Thợ phụ</option>
