        ...
        <div class="row" style="margin-top: 40px">
            <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post">
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Ngày hết hạn <span
                                class="required">*</span></label>
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <input id="txtExpired" name="txtExpired" class="date-picker form-control col-md-6" required
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Bộ phận <span
                                class="required">*</span></label>
...
<!--                            <option value="2">Vận hành, kiểm thử</option>-->
                            <option value="4">Thợ kỹ thuật</option>
                            <option value="5">Thợ phụ</option>
                        </select>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <select name="slDepartment" id="slDepartment" class="form-control col-md-7 col-xs-12">
                            <option value="10">Thợ kỹ thuật</option>
                            <option value="11">Thợ phụ</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" id="txtTitle" name="txtTitle" required="required"
                               class="form-control col-md-7 col-xs-12" placeholder="Tiêu đều tiếng Việt">
                        <input type="text" id="txtTitleEn" name="txtTitleEn" required="required"
                               class="form-control col-md-7 col-xs-12" placeholder="Tiêu đều tiếng Anh"
                ...
                <div class="form-group" style="margin-top: 30px">
                    <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-2" style="width: 70px">
                        <input type="submit" id="btnAddRecruitment" name="btnAddRecruitment" required="required"
...
<script>
    $(document).ready(function () {
        ...
        $('#slDepartment1').on('change', function () {
            ...
            if (this.value === "4") {
                $('#slDepartment').html('<option value="10">Thợ kỹ thuật</option>');
            }
            else if (this.value === "5") {
                $('#slDepartment').html('<option value="11">Thợ phụ</option>');
            }
            else {
                $('#slDepartment').html(
                    '<option value="10">Thợ kỹ thuật</option>' +
